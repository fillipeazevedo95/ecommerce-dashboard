...
describe('Layout Actions', () => {
    ...
    describe('Actions Creatores', () => {
        test('deve retornar o action creator showMessage { type : SHOW_MESSAGE }', () => {
            expect(Creators.showMessage()).toEqual({ type: Types.SHOW_MESSAGE })
        })
        test('deve retornar o action creator hideMessage { type : HIDE_MESSAGE }', () => {
